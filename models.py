...
def get_mobilenet(n_classes, pretrained=True):
    ...
    # Modify the first layer to accept single-channel (grayscale) input images (MNIST)
    input_channel = 1
    model.features[0][0] = nn.Conv2d(input_channel, model.features[0][0].out_channels,
                                     kernel_size=3, stride=2, padding=1, bias=False)

    # Modify the classifier to have `n_classes` outputs
