...
class FileActivitySimulator(ActivitySimulator):
    ...
    def get_active_clients(self):
        """returns indices of active clients_dict
...
class DeterministicActivitySimulator(ActivitySimulator):
    """In a system with two clients:
        - the first client is always active
        - the second client is active at the end of the training
    """
    def __init__(
            self,
            clients_ids,
        ...
        super(DeterministicActivitySimulator, self).__init__(
            clients_ids=clients_ids,
            availability_types=availability_types,
            availabilities=availabilities,
            stability_types=stability_types,
        ...
        assert n_clients == 2, "DeterministicActivitySimulator is only implemented for N=2 clients!"
    ...
    def get_active_clients(self):
        ...
        if self.time_step in range(700, 800):
            active_ids_per_time = [0, 1]
        else:
            active_ids_per_time = [0]

        return active_ids_per_time
